...
uses
  ...
  Menus, StdCtrls, ExtCtrls, ComCtrls, uFindFile, ImgList;
...
procedure TMainForm.FindFileFileMatch(Sender: TObject;
...
procedure TMainForm.OpenFileLocationItemClick(Sender: TObject);
var
  Param: String;
begin
  if FoundFiles.Selected <> nil then
...
procedure TMainForm.CBDClick(Sender: TObject);
begin
  CreatedBeforeDate.Enabled := CBD.Checked;
end;

procedure TMainForm.CBTClick(Sender: TObject);
begin
  CreatedBeforeTime.Enabled := CBT.Checked;
end;

procedure TMainForm.CADClick(Sender: TObject);
begin
  CreatedAfterDate.Enabled := CAD.Checked;
end;

procedure TMainForm.CATClick(Sender: TObject);
begin
  CreatedAfterTime.Enabled := CAT.Checked;
end;

procedure TMainForm.MBDClick(Sender: TObject);
begin
...
procedure TMainForm.MADClick(Sender: TObject);
begin
  ModifiedAfterDate.Enabled := MAD.Checked;
end;

procedure TMainForm.MATClick(Sender: TObject);
begin
  ModifiedAfterTime.Enabled := MAT.Checked;
end;

procedure TMainForm.ABDClick(Sender: TObject);
begin
  AccessedBeforeDate.Enabled := ABD.Checked;
end;

procedure TMainForm.ABTClick(Sender: TObject);
begin
  AccessedBeforeTime.Enabled := ABT.Checked;
end;

procedure TMainForm.AADClick(Sender: TObject);
begin
  AccessedAfterDate.Enabled := AAD.Checked;
end;

procedure TMainForm.AATClick(Sender: TObject);
begin
